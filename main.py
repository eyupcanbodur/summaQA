...
def trainModel(model):
    ...
    if modelType == ModelType.NOT_TRAINED:
        ...
        train_data = takeDataFromSquadDataset(params[Params.TRAINING_DATA_PATH])
...
def getHelp():
    ...
    print(
        ModelType.TRAINED.value
        + " "
        + Params.TRAINED_MODEL_PATH.value
        + " "
        + Params.EVALUATION_DATA_PATH.value
    )
    print("or:")
    print(
        ModelType.NOT_TRAINED.value
        + " "
        + Params.TRAINING_DATA_PATH.value
        + " "
        + Params.EVALUATION_DATA_PATH.value
    )
...
def read_and_check_params():
    ...
    if (
        sys.argv[1] == ModelType.TRAINED.value
        or sys.argv[1] == ModelType.NOT_TRAINED.value
    ):
